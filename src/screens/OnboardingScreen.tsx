...
const OnboardingScreen = () => {
  ...
  const translatedSteps = STEPS.map((step, i) => ({
    ...
    description: [
      ...
      t.onboarding.trackExpensesDesc,
      t.onboarding.multiWalletDesc,
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={[styles.nextBtn, { backgroundColor: theme.colors.primary }]} onPress={handleNext}>
          <Text style={styles.nextText}>{isLastStep ? t.onboarding.getStarted : t.onboarding.next}</Text>
