...
const hi: TranslationKeys = {
  ...
  settings: {
    ...
    resetDataConfirm:
      'यह आपके सभी खर्चे, वॉलेट और बजट स्थायी रूप से हटा देगा। श्रेणियां और सेटिंग्स सुरक्षित रहेंगी। यह पूर्ववत नहीं किया जा सकता।',
    ...
    resetDatabaseConfirm:
      'यह ऐप को उसकी प्रारंभिक स्थिति में पूरी तरह रीसेट करेगा। श्रेणियों, खर्चों, वॉलेट और सेटिंग्स सहित सारा डेटा स्थायी रूप से हटा दिया जाएगा। यह पूर्ववत नहीं किया जा सकता।',
  ...
  addExpense: {
    ...
    enterAmount: 'कृपया एक वैध राशि दर्ज करें',
  ...
  security: {
    ...
    disabled: 'अक्षम',
    securityTip:
      'अधिकतम सुरक्षा के लिए, हम बायोमेट्रिक प्रमाणीकरण सक्षम करने की सलाह देते हैं। आपका डेटा हमेशा आपके उपकरण पर स्थानीय और एन्क्रिप्टेड रहता है।',
  ...
  updateChecker: {
    title: 'अपडेट उपलब्ध',
    message: 'नया संस्करण ({version}) उपलब्ध है। नवीनतम सुविधाओं और सुधारों के लिए अभी अपडेट करें।',
    update: 'अपडेट करें',
    later: 'बाद में',
    upToDate: 'नवीनतम संस्करण',
    upToDateMessage: 'आप नवीनतम संस्करण ({version}) चला रहे हैं।',
    checkFailed: 'अपडेट जाँच नहीं हो सकी। कृपया बाद में पुनः प्रयास करें।',
  },
};
